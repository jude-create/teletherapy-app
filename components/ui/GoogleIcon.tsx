...
const GoogleIcon = ({ size = 22 }: GoogleIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 48 48">
    ...
    <Path
      fill="#4CAF50"
      d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.2 35.1 26.7 36 24 36c-5.3 0-9.8-3.4-11.4-8.1L6.1 33C9.5 39.5 16.2 44 24 44z"
    />
    <Path
      fill="#1976D2"
