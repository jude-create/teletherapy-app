...
const RootNavigator = () => {
  ...
  const loadUserRole = async (nextUser) => {
    ...
    try {
      ...
      console.warn('Unable to resolve user role:', error.message);
  ...
  const renderNavigator = () => {
    ...
    if (role === 'patient') {
      const PatientNavigator = require('./PatientNavigator').default;
      return <PatientNavigator />;
    }

    if (role === 'therapist') {
      const TherapistNavigator = require('./TherapistNavigator').default;
