...
const callNumber = (number: string) => openUrl(`tel:${number}`);
const textNumber = (number: string) => openUrl(Platform.OS === 'ios' ? `sms:${number}` : `sms:${number}`);

const ResourceRow = ({ Icon, title, body }: any) => (
