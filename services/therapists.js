...
export const normalizeTherapistProfile = (therapist = {}, id) => {
...
export const isTherapistBookable = (therapist = {}) => {
...
export const isTherapistVisible = (therapist = {}) => {
  const normalized = normalizeTherapistProfile(therapist);
  return Boolean(
...
export const createTherapistAccount = async ({ email, password, therapist }) => {
...
export const getTherapistByUid = async (uid) => {
  if (!uid) return null;
...
export const findTherapistsByTherapyType = async (therapyType) => {
...
export const updateTherapist = async (uid, data) => {
...
export const updateTherapistAvailability = async (uid, data) => {
...
export const saveTherapistQuestionnaire = async (uid, data) =>
  updateTherapist(uid, {
    ...data,
