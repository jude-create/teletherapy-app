...
export const makeTypography = (palette = colors): Record<string, TextStyle> => ({
  title: {
    fontSize: 28,
    lineHeight: 34,
    fontWeight: '800',
...
const buildTheme = (mode: ThemeMode, themePreference: ThemePreference = mode) => {
  ...
  useEffect(() => {
    ...
    AsyncStorage.getItem(THEME_STORAGE_KEY)
      .then((savedPreference) => {
        if (mounted && isThemePreference(savedPreference)) {
